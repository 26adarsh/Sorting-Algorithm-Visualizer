...
def drawData(data, colorArray):
    ...
    for i, height in enumerate(normalised_data):
        ...
        y0 = canvas_height - height * 400  # Normalizing height for canvas (assuming data in range 0-100)
        x1 = (i + 1) * x_width
        y1 = canvas_height
...
# Function to generate a new array based on user input
def Generate():
    global data
...
algo_menu = ttk.Combobox(root, width=20, font=("new roman", 19, "italic bold"), textvariable=selected_algorithm, values=['Bubble Sort', 'Selection Sort', 'Insertion Sort', 'Merge Sort', 'Quick Sort'], state='readonly')
...
sizevaluelabel = Label(root, text="Size: ", font=("new roman", 16, "italic bold"), bg="#0E6DA5", width=10, fg="black", height=2, relief=GROOVE, bd=5)
sizevaluelabel.place(x=0, y=60)

sizevalue = Scale(root, from_=3, to=30, resolution=1, orient=HORIZONTAL, font=("arial", 14, "italic bold"), relief=GROOVE, bd=2, width=10)
sizevalue.place(x=120, y=60)

minvaluelabel = Label(root, text="Min Value: ", font=("new roman", 16, "italic bold"), bg="#0E6DA5", width=10, fg="black", height=2, relief=GROOVE, bd=5)
...
maxvaluelabel = Label(root, text="Max Value: ", font=("new roman", 16, "italic bold"), bg="#0E6DA5", width=10, fg="black", height=2, relief=GROOVE, bd=5)
maxvaluelabel.place(x=500, y=60)

maxvalue = Scale(root, from_=10, to=100, resolution=1, orient=HORIZONTAL, font=("arial", 14, "italic bold"), relief=GROOVE, bd=2, width=10)
...
speedlabel = Label(root, text="Speed: ", font=("new roman", 16, "italic bold"), bg="#0E6DA5", width=10, fg="black", relief=GROOVE, bd=5)
